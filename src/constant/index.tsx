...
export const listClass1 = ['10A1', '10A2', '10A3', '10A4', '10A5', '10A6', '10A7', '10A8', '10A9'];

export const listClass2 = ['11A1', '11A2', '11A3', '11A4', '11A5', '11A6', '11A7', '11A8', '11A9'];

export const listClass3 = ['12A1', '12A2', '12A3', '12A4', '12A5', '12A6', '12A7', '12A8', '12A9'];
  ...
  return {
    ...
    renderCell: (params) => (
      <Box sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-evenly'}}>
        {params.row[day.field].map((p: any, index: any) => <Typography key={index} variant='subtitle1' fontSize={15}>{p}</Typography>)}
      </Box>
    )
  }
})
